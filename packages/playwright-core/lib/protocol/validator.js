...
import_validatorPrimitives.scheme.BrowserContextEnableRecorderParams = (0, import_validatorPrimitives.tObject)({
  ...
  showRecorder: (0, import_validatorPrimitives.tOptional)(import_validatorPrimitives.tBoolean),
  actionListener: (0, import_validatorPrimitives.tOptional)(import_validatorPrimitives.tAny)
});
